...
{
       0,    69,    69,    72,    75,    76,    83,    84,    87,    88,
      91,    92,    95,    96,    99,   100,   103,   110,   111,   114,
     115,   118,   119,   122,   123,   126,   127,   130,   131,   134,
     135,   138,   139,   142,   143,   146,   147,   150,   151,   154,
     155,   158,   159,   162,   163,   164,   165,   166,   167,   168,
     169,   170,   173,   223,   231,   232,   235,   243,   246,   247,
     248,   249,   250,   251,   252,   253,   254,   255,   256,   257,
     260,   269,   272,   273,   276,   277,   280,   281,   284,   285,
     288,   291,   294,   295,   296,   297,   298,   301,   304,   307,
     311,   319,   322,   323,   326,   327,   330,   331,   334,   335,
     338,   341,   344,   345,   348,   349,   350,   353,   354,   357,
     358,   361,   362,   365,   366,   369,   370,   373,   374,   377,
     380,   381,   384,   385,   388,   389,   392,   393,   394,   395,
     396,   397,   398,   399,   402,   406,   412,   413,   416,   417,
     420,   421,   424,   425,   428,   429,   432,   433,   436,   437,
     440,   443,   444,   447,   448,   451,   452,   455,   456,   459,
     460,   463,   464,   471,   475,   482,   483,   486,   487,   490,
     491,   494,   495,   498,   499,   502,   503,   506,   507,   510,
     511,   514,   515,   518,   519,   553,   554,   555,   556,   557,
     558,   559,   560,   561,   562,   563,   566,   567,   570,   571,
     574,   575,   578,   579,   582,   583,   586,   587,   598,   599,
     602,   603,   620,   621,   622,   623,   626,   649,   652,   653,
     654,   657,   661,   678,   679,   682,   683,   684,   685,   686,
     691,   695,   699,   702,   703,   706,   707,   710,   711,   714,
     715,   718,   726,   736,   737,   740,   741,   744,   745,   748,
     749,   750,   753,   754,   757,   758,   761,   762,   766,   769,
     770,   773,   774,   777,   778,   781,   782,   785,   786,   789,
     790,   793,   794,   797,   798,   801,   802,   805,   806,   809,
     810,   813,   814,   817,   820,   821,   824,   825,   828,   829,
     832,   833,   834,   837,   838,   841,   842,   845,   846,   849,
     850,   853,   854,   857,   858,   861,   862,   865,   866,   869,
     870,   873,   874,   877,   878
};
#endif
...
#line 1938 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 103 "includes/parse.y" /* yacc.c:1646  */
    {
...
#line 2129 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 57:
#line 243 "includes/parse.y" /* yacc.c:1646  */
    {(yyval.node) = nullptr;}
...
#line 2201 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 69:
#line 257 "includes/parse.y" /* yacc.c:1646  */
...
#line 311 "includes/parse.y" /* yacc.c:1646  */
    {
			...
			(yyval.node) = new ReturnNode(node);
			pool.add((yyval.node));
			pool.add(node);
		}
...
#line 402 "includes/parse.y" /* yacc.c:1646  */
    {
			(yyval.node) = new IfElseNode((yyvsp[-6].node), (yyvsp[-4].node), (yyvsp[0].node));
			pool.add((yyval.node));
		}
...
#line 2415 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 141:
#line 421 "includes/parse.y" /* yacc.c:1646  */
    {return 0;}
...
#line 519 "includes/parse.y" /* yacc.c:1646  */
    {
			if((yyvsp[-2].node)){
				if((yyvsp[-1].tokenType) == LESS){
					(yyval.node) = new LessThanBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == GREATER){
					(yyval.node) = new GreaterThanBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == EQEQUAL){
					(yyval.node) = new EqualsBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == GREATEREQUAL){
					(yyval.node) = new GreaterThanEqualBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == LESSEQUAL){
					(yyval.node) = new LessThanEqualBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == GRLT){
					(yyval.node) = new GreaterThanLessThanBinaryNode((yyvsp[-2].node), (yyvsp[0].node));
					pool.add((yyval.node));
				}
				if((yyvsp[-1].tokenType) == NOTEQUAL){
...
#line 2673 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 199:
#line 571 "includes/parse.y" /* yacc.c:1646  */
    {(yyval.node)=nullptr;}
...
#line 3034 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 253:
#line 754 "includes/parse.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[-1].node);}
...
#line 3073 "parse.tab.c" /* yacc.c:1646  */
  ...
  case 259:
#line 769 "includes/parse.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[0].node);}
...
#line 873 "includes/parse.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[0].node);}
#line 3115 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 881 "includes/parse.y" /* yacc.c:1906  */
